...
register("chat", () => in_p3 = true).setCriteria("[BOSS] Storm: I should have known that I stood no chance.")
register("chat", () => in_p3 = false).setCriteria("The Core entrance is opening!")
